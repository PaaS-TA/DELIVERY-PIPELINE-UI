...
<link rel="stylesheet" type="text/css" href="<c:url value='/resources/js/jquery.tzSelect.css'/>">
...
<script type="text/javascript" src="<c:url value='/resources/js/jquery.svgDoughnutChart.js' />"></script>
<script type="text/javascript" src="<c:url value='/resources/js/jquery.tzSelect.js' />"></script>
