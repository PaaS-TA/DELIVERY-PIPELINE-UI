            ...
            <div class="log_histioy">
                ...
                <div class="header">
                    ...
                    <div class="btn_wrap">
                        ...
                        <button type="button" class="button btn_default" title="Download" id="btnDownload">Download</button>
...
<input type="hidden" id="jobFileId" name="jobFileId" value="" />
...
<script type="text/javascript">
    ...
    var setJobHistoryInfo = function (reqDataIndex) {
        ...
        $('#btnDownload').attr('disabled', downloadYn);
    ...
    var triggerJob = function () {
        ...
        var param = {
            ...
            jobNumber : jobNumber,
            jobType : "<%= Constants.JOB_TYPE_BUILD %>"
        };
    ...
    $("#btnTrigger").on("click", function() {
        getGrantedAuthorities(document.getElementById('pipelineIdControlAuthority').value, "job", "trigger");
    ...
    $("#btnStop").on("click", function() {
        getGrantedAuthorities(document.getElementById('pipelineIdControlAuthority').value, "job", "stop");
        /*for(var i = 0; i < grAry.length; i++){
            if(grAry[i].authCode == document.getElementById('pipelineIdControlAuthority').value){
                if(grAry[i].authority.code == "read"){
                    procPopupAlert("You do not have permission.");
    ...
    $("#btnUpdate").on("click", function() {
        var reqUrl = JOB_PIPELINE_URL + "/<c:out value='${id}' default='' />/build/update";
        procMovePage(reqUrl);
    });
    ...
    $("#btnDownload").on("click", function() {
        var jobFileId = parseInt(document.getElementById('jobFileId').value, 10);

        if (jobFileId > 0) {
            procDownload(jobFileId);
        } else {
            procPopupAlert("The file does not exist.");
        }
    });
