...
<br>
QualityGate registration page :: QUALITY GATE CREATE PAGE
<br>
<ul>
    ...
    <li>USER NAME :: <input type="text" id="userName" title="" value="User"></li>
...
<script type="text/javascript">
    ...
    var callbackCreateQualityGate = function(data) {
        ...
        $('#resultArea').html("Registration complete <br><br>QUALITY GATE ID :: " + data.id);
    };
