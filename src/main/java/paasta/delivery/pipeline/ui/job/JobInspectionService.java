...
public class JobInspectionService {
    ...
    List getQualityProfileList(String serviceInstancesId) {
        return restTemplateService.send(Constants.TARGET_INSPECTION_API, REQ_URL + "/qualityProfile/qualityProfileList?serviceInstancesId=" + serviceInstancesId, HttpMethod.GET, null, List.class);
    }
